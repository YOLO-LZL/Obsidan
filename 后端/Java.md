...
第 251页韩顺平循序渐进学 Java 零基础

}
```
#### 注意事项
- 构造器也可以重载
- 如果程序员没有定义构造器，系统会默认给一个无参构造器（默认构造器）
- 当定义了构造器，默认构造器会被覆盖，除非显式地定义一下，例如：Dog(){};
### this关键字
#### 什么是this
...
![](assets/Java/file-20251201164330762.png)
- ==只有公开和默认可以用来修饰类==
### 面向对象三大特征
#### 封装
##### 基本介绍
